...
//Проставляти підписантів
/*
function onChangeLevel() {
debugger;
    switch (EdocsApi.getAttributeValue('Level').value) {
                case '29':
            EdocsApi.setAttributeValue({code: 'Director', value: '662', text: null});
            break;
        case '26':
            EdocsApi.setAttributeValue({code: 'Director', value: '7599', text: null});
            break;
        case '13':
            EdocsApi.setAttributeValue({code: 'Director', value: '167', text: null});
			 break;
        case '29':
            EdocsApi.setAttributeValue({code: 'Director', value: '167', text: null});
			EdocsApi.setAttributeValue({code: 'Director', value: '168', text: null});
            break;
         
        default:
            EdocsApi.setAttributeValue({code: 'Director', value: null, text: null});
            break;
    }
}
*/
